...
if __name__ == "__main__":
    ...
    try:
        ...
        if setup_monitoring(project_root):
            logger.info("Monitoring stack started successfully")
        else:
            logger.warning("Failed to start monitoring stack. Continuing without monitoring.")
    except Exception as e:
        logger.error(f"Error initializing monitoring stack: {e}")
