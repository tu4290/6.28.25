...
from data_models import RawUnderlyingDataCombinedV2_5, RawOptionsContractV2_5 # Updated import
...
class TradierDataFetcherV2_5:
    ...
    async def fetch_raw_quote_data(self, symbol: str) -> Optional[Dict[str, Any]]:
